(() => {
  ...
  qs('#medicalForm')?.addEventListener('submit', (e) => {
    ...
    notes.push({ text: 'Medical tariff updated to V13 effective August 1, 2026. Required documents: signed medical proposal, copy of ID, continuity proof/medical card if available, and additional reports if requested.' });
